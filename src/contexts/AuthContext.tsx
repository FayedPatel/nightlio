...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  // localStorage.getItem returns string | null; null simply means "no stored
  // session" and flows into the cookie-restore path below.
  ...
  const applyLogin = useCallback((jwtToken: string, userData: User) => {
  ...
  const localLogin = useCallback(async (): Promise<AuthResult> => {
    try {
      setLoading(true);
