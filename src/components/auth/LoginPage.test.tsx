...
// Only the keys LoginPage reads; signup_url must stay string | null so the
// per-test reassignments below typecheck.
interface TestConfig {
  enable_oidc: boolean;
  signup_url: string | null;
}
const configState: { config: TestConfig; loading: boolean } = {
